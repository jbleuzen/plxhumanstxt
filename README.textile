...
PlxHumansTxt is a plugin for PluXml CMS, it allows PluXml to easily create and manage your _humans.txt_ files for your PluXml site.

Enabling the plugin on your site will add the following line within the head tag of all your pages : 
@<link type="text/plain" rel="author" href="http://your.website.com/humans.txt" />@
...
Just make sure there is no capitalized letter in the plugin folder name.
